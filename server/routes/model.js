...
// ── URL helpers ───────────────────────────────────────────
// Derive OpenAI + Anthropic base URLs from a stored base_url + is_coding_plan
function getEndpoints(baseUrl, isCodingPlan) {
  ...
  // Pay-as-you-go: use whatever base_url the user saved
...
// ── test_provider ─────────────────────────────────────────
// For BAILIAN: tests both OpenAI-compatible and Anthropic-compatible endpoints.
// For others: simple api_key presence check.
