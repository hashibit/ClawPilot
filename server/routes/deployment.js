...
function generateOpenclawConfig(opcId) {
  ...
  return {
    ...
    gateway: {
      ...
      mode: 'local',
      bind: 'loopback',
      auth: { mode: 'token', token: '' }, // Token will be generated by daemon
    ...
    logging: { level: 'debug' },
    plugins: {
      allow: Object.keys(channelsSection).length > 0 ? ['feishu'] : [],
      entries: Object.keys(channelsSection).length > 0 ? channelsSection : {},
    },
  }
}
